...
[点我-项目定制](https://www.liyansheng.top/blog/issues_flow/)
...
|  3   |   定制开发（按需求文档全新开发）   |  商定  | 需评估功能与工期 |

### **二、二次开发与调试**

| 序号 |         服务内容          | 服务费 |       备注       |
| :--: | :-----------------------: | :----: | :--------------: |
|  4   | 功能扩展/二改（已有项目） |  45+   |   需提供原代码   |
|  5   |     开源项目调试+改进     |  60+   | 含适配与功能扩展 |
|  6   |        修复已知Bug        |  45+   |  需明确问题描述  |
|  7  |       新增功能模块        |  45+   |   需评估复杂度   |
|  8  |      微信小程序调试       |  60+   | 含接口与功能修复 |

### **三、程序调试**（您自带项目）

| 序号 |            服务内容            | 服务费 |       备注        |
| :--: | :----------------------------: | :----: | :---------------: |
|  9   | 普通项目调试（Swing/GUI/脚本） |  40+   | 环境/逻辑问题排查 |
|  10   | 综合项目调试（Java/Python等）  |  50+   |  含框架配置修复   |
|  11  |     开源项目试错匹配+调试      |  70+   |  需提供需求说明   |

### **四、文档与设计服务**

| 序号 |          服务内容          | 服务费 |      备注      |
| :--: | :------------------------: | :----: | :------------: |
|  12  |       报告代写        | 纯文字平均【8+元/页】 <br> 文字+图表 平均【13元/页】 |  可具体商议    |
| 13 | 论文代写 | 纯论文类平均 【12+元/页】 <br/> 论文包查重类平均 【20+/页】 | 可具体商议 |
|  14  | 纯制图（类图/ER图/时序图等） | 平均【15+元/个】 | 需提供基础需求，综合复杂程度 |

### **五、辅助服务**

| 序号 |           服务内容           | 服务费 |      备注      |
| :--: | :--------------------------: | :----: | :------------: |
|  15  |   一对一技术答疑，项目讲解   | 80+/h  | 按实际时长计费 |
|  16  | 开发环境安装（IDE/数据库等） |  10+   |    远程协助    |
