...
![](http://liyansheng.top/typora/404.png)
...
<body style="background-color: rgb(55, 89, 161);">
    <main>
        <div class="container" style="color: aliceblue;text-align: center;margin-top: 10%;">
            <img src="http://liyansheng.top/typora/404.png" alt="404">
            <br>
            <h2>抱歉，没有找到您请求的页面！</h2>
...
![](http://liyansheng.top/typora/no_auc.png)
...
<body style="background-color: rgb(55, 89, 161);">
    <main>
        <div class="container" style="color: aliceblue;text-align: center;margin-top: 10%;">
            <img src="http://liyansheng.top/typora/no_auc.png" alt="404">
            <br>
            <h2>抱歉，当前操作不可进行！</h2>
